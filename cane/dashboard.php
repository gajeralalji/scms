...
<br/>
                        ...
                        <div class="panel-body">
                            <form role="form" action="add_user.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls"><input type="email" name="email" id="" class="form-control input-sm" placeholder="Email" required >
                                	<p class="help-block"></p>
                                	</div></div>
                                </div>
								<div class="form-group">
                                    <label for="username">Username</label>
                                    <input type="text" name="username" id="" class="form-control input-sm" placeholder="username" required >
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
        ...
        data-validation-pas-message=" must contain at least one digit and one uppercase character, length must between 8 to 20" 
         id="" class="form-control input-sm" placeholder="Password" required >
                                         <p class="help-block"></p>
    </div> </div>
                                    </div>
                                    <div class="col-md-6">
							...
							<div class="form-group">
									<div class="checkbox" >
										<label>
											<input type="checkbox" required> I accept to SCMS terms and Privacy
										</label>
									</div>
								</div>
