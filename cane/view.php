...
if (isset($_GET['search'])) {
	$search=$_GET['search'];
$query_users = "SELECT * FROM members where username like '%$search%' or firstname like '%$search%' or lastname like '%$search%' or birthdate like '%$search%' or email like '%$search%' or gender like '%$search%'";	
}else {
$query_users = "SELECT * FROM members";
}
...
<html lang="en">
 ...
 <a class="btn btn-success" href="dashboard.php" role="button">Add New User</a>  
<a class="btn btn-success" href="view.php" role="button">View</a>        
<br/>
                    ...
                    <?php do { ?>
                      <tr>
                       ...
                       <td><?php echo $row_users['user_type']; ?></td>
                        ...
                        <?php echo '<td><a href="edit_user.php?id=' . $row_users['id'] . '"><button type="button" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="top" title="Edit">
  <span class="glyphicon glyphicon-edit"></span>
</button></a>&nbsp;';
                echo '<a onclick="return window.confirm(\'Are You sure ? Do you want to delete this row?\');" href="delete_user.php?id=' . $row_users['id'] . '"><button type="button" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="top" title="Delete">
