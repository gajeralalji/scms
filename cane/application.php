...
$query_users = "SELECT * FROM job where notif=1";
...
$query_users = mysql_query("update job set notif=0 where notif=1");
?>
<!DOCTYPE html>
<html lang="en">
    <head>
...
<br/>
            ...
            <div class="row clearfix">
				...
				<?php if($totalRows_users==0) echo "<div class='col-md-3 col-md-offset-1'><div class='alert alert-success'><p><b>You Have seen all notifications !</b></p></div></div>"; else {?>
