...
if (isset($_GET['search'])) {
	$search=$_GET['search'];
$query_users = "SELECT * FROM weight where ticket_code like '%$search%' or cutting_order_code like '%$search%' or vehicle_type like '%$search%' or id like '%$search%' or weight_vehicle like '%$search%' or net_weight like '%$search%'";	
}else {
$query_users = "SELECT * FROM weight";
}
...
<br/>
            ...
            <div class="row centered-form">
                ...
                <div class="panel panel-primary">
 				 ...
 				 <div class="panel-heading" align="center">USERS</div>
	<div class="table-responsive">
                  <table class="table table-condensed table-striped table-bordered" >
                    <tr>
                      <td><b>Ticket code</b></td>
                      <td><b>Cutting order code</b></td>
                      <td><b>Vehicle type</b></td>
                      <td><b>Id</b></td>
                      <td><b>Weight vehicle</b></td>
                    ...
                    <?php do { ?>
                      <tr>
                        ...
                        <td><?php echo $row_users['cutting_order_code']; ?></td>
                        <td><?php echo $row_users['vehicle_type']; ?></td>
                        <td><?php echo $row_users['id']; ?></td>
                        <td><?php echo $row_users['weight_vehicle']; ?></td>
                       <td><?php echo $row_users['net_weight']; ?></td>
...
$row_users1= mysql_fetch_assoc($users1);?>
                       ...
                       <td><?php echo $row_users1['firstname']; ?></td>
                        ...
                        <?php echo '<td><a href="edit_weight.php?id=' . $row_users['ticket_code'] . '"><button  type="button" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="top" title="Edit">
  <span class="glyphicon glyphicon-edit"></span>
</button></a>&nbsp;';
                echo '<a onclick="return window.confirm(\'Are You sure ? Do you want to delete this row?\');" href="delete_weight.php?id=' . $row_users['ticket_code'] . '"><button type="button" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="top" title="Delete">
