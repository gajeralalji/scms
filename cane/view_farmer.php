...
if (isset($_GET['search'])) {
	$search=$_GET['search'];
$query_users = "SELECT * FROM farmers where address like '%$search%' or firstname like '%$search%' or lastname like '%$search%' or birthdate like '%$search%' or email like '%$search%' or gender like '%$search%' or farmer_type like '%$search%' or village_name like '%$search%' or village_code like '%$search%' or zone_name like '%$search%' or zone_code like '%$search%' or taluka like '%$search%' or taluka_code like '%$search%' or district like '%$search%' or ph_no like '%$search%' or mo_no like '%$search%' or ifsc like '%$search%'";	
}else {
$query_users = "SELECT * FROM farmers";
}
...
<br/>
            ...
            <div class="row centered-form">
                ...
                <div class="panel panel-primary">
 				 ...
 				 <div class="panel-heading" align="center">Farmers</div>
	<div class="table-responsive">
                  <table class="table table-condensed table-striped table-bordered" >
                    <tr>
                      ...
                      <td><b>gender</b></td>
                      <td><b>birthdate</b></td>
                      <td><b>Farmer type</b></td>
                      <td><b>Address</b></td>
                      
                      <td><b>vilage name</b></td>
                    ...
                    <?php do { ?>
                      <tr>
                       ...
                       <td><?php echo $row_users['birthdate']; ?></td>
                       <td><?php echo $row_users['farmer_type']; ?></td>
                       <td><?php echo $row_users['address']; ?></td>
                       <td><?php echo $row_users['village_name']; ?></td>
                       
                       <td><?php echo $row_users['taluka']; ?></td>
                       <td><?php echo $row_users['district']; ?></td>
                       <td><?php echo $row_users['mo_no']; ?></td>
                        
                       
                        <?php echo '<td><a href="edit_farmer.php?id=' . $row_users['id'] . '"><button  type="button" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="top" title="Edit">
  <span class="glyphicon glyphicon-edit"></span>
</button></a>&nbsp;';
                echo '<a onclick="return window.confirm(\'Are You sure ? Do you want to delete this row?\');" href="delete_farmer.php?id=' . $row_users['id'] . '"><button type="button" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="top" title="Delete">
